<script lang="ts" setup>
  ...
  const collapsedIcon = computed(() =>
    sidebar.isCollapsedMixedSidebar ? 'mdi:chevron-triple-right' : 'mdi:chevron-triple-left',
  )
  const mixSideModeClass = computed(() =>
    sidebar.isCollapsedMixedSidebar ? 'collapsed' : undefined,
  )
