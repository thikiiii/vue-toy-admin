...
export const useRouteStore = defineStore('route', {
    ...
    actions: {
        ...
        filterAuthRoutes(routeList: Route.RouteRecordRaw[]): Route.RouteRecordRaw[] {
            ...
            // 将过滤好的权限路由返回
            return routeList.reduce<Route.RouteRecordRaw[]>(
                (authRoutes, route) => {
                    // PUSH 权限路由
                    const pushAuthRoute = () => {
        ...
        initFrontRouteAuth() {
            ...
            RouterHelpers.transformCustomRoutesToVueRoutes(RouterHelpers.useLayoutWrapperSingleViewRoute(routes)).forEach(route => router.addRoute(route))
